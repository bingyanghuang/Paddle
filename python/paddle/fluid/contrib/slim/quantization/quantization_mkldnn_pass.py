...
class TransformForMkldnnPass(object):
    ...
    IrGraph. Following transformations did in this pass:
        1. Convert int8 range weights with float32 data type, which are generated by 
           ...
           conv2d kernel and mul kernel now only supports float32 weights input, will 
           do weights quantization inside the conv2d and mul INT8 kernel.
        2. Create the new conv2d and mul op with the converted weights and link its output
